...
public class ObstacleElectroPad extends Obstacle
{
    public ObstacleElectroPad(String name, double posX, double posY)
    {
        ...
        this.description = "A pad which speeds---up bullets and stuns tanks";
    }
